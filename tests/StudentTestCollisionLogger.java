...
public class StudentTestCollisionLogger {
    ...
    public void TestMaxValue() {
        ...
        logger.printCollisionLoggerInformation();
    }
    ...
    public void TestCollisionEverywhereEqual() {
        ...
        int[][] actual = logger.getNormalizedHeatMap();
        logger.printCollisionLoggerInformation();
        EasyBufferedImage image = EasyBufferedImage.createImage(actual);
        try {
            image.save("heatmaptest2"+".png", EasyBufferedImage.PNG);
    ...
    public void TestCollisionHalfMap() {
        ...
        EasyBufferedImage image = EasyBufferedImage.createImage(actual);
        try {
            image.save("heatmaptest"+".png", EasyBufferedImage.PNG);
        } catch (IOException exc) {
            exc.printStackTrace();
            System.exit(1);
        }
